...
function foliox_tm_contact_form(){
    ...
    var messageBox  = jQuery(".contact_form .returnmessage");
    ...
    form.on("submit", function(e){
        ...
        var endpoint    = currentForm.attr("action");
        var successMsg  = messageBox.data("success");
        ...
        currentForm.addClass("is-sending");
        ...
        jQuery.ajax({
            ...
            data: {
                ...
                _subject: "New Foliox portfolio inquiry",
                _captcha: "false",
                _template: "table"
            }
        })
        .done(function(){
            messageBox
                .html("<span class='contact_success'>" + successMsg + "</span>")
        ...
        .fail(function(){
            messageBox
                .html("<span class='contact_error'>We could not send your message. Please try again later.</span>")
                .slideDown(500).delay(4000).slideUp(500);
        })
        .always(function(){
            currentForm.removeClass("is-sending");
        });
...
// 		messageBox.stop(true, true).hide().empty();
...
// 			messageBox.append("<span class='contact_success'>"+ successMsg +"</span>");
// 			messageBox.slideDown(500).delay(4000).slideUp(500);
// 			currentForm[0].reset();
			
// 		}).fail(function(){
			
// 			messageBox.append("<span class='contact_error'>We could not send your message. Please try again later.</span>");
// 			messageBox.slideDown(500).delay(4000).slideUp(500);
